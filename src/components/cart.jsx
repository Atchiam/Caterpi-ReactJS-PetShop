            ...
            <div className="container py-5">
                <div className="row">
                    <div className="col-md-12 text-center">
                        <div className="alert alert-danger" role="alert">No Tenes Productos en el Carrito!</div>
                        <Link to={"/"} className="btn">Ir al catalogo!</Link>
                    </div>
                </div>
            </div>
        )
                            ...
                            <tbody>
                                {cart.map(item => (
                                    <tr key={item.id}>
                                        ...
                                        <td className="text-end align-middle"><Link onClick={() => {removeItem(item.id)}} title="Eliminar Producto"><img src={"images/eliminar.png"} alt={"Eliminar Producto"} width={24} /></Link></td>
                                    </tr>
                                ))}
                                <tr>
                                    <td colSpan={2}>&nbsp;</td>
